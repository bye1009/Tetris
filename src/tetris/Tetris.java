...
public class Tetris extends JFrame {
     ...
     * 积多少分以后能升级
     */
    public final static int PER_LEVEL_SCORE = PER_LINE_SCORE * 6;
    /**
     * 最大级数是10级
     */
    ...
    private void creatMenu() {
        ...
        miSetBlockColor.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Color newFrontColor =
                        JColorChooser.showDialog(Tetris.this, "设置方块颜色", canvas.getBlockColor());
        ...
        miSetBackColor.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Color newBackColor =
                        JColorChooser.showDialog(Tetris.this, "设置背景颜色", canvas.getBackgroundColor());
        ...
        miAuthor.addActionListener(new ActionListener() {                        
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "殷玉洁 && 周星玥", "软件设计实践", 1);
            }
        });
